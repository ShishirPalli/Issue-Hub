...
const STATUS_TRANSITIONS = {
  submitted:   ['in_progress', 'withdrawn'],
  in_progress: ['resolved', 'withdrawn'],
  resolved:    ['closed', 'in_progress'],   // re-open if student rejects resolution
  closed:      [],                           // terminal
  withdrawn:   [],                           // terminal
};
...
/**
 * Check whether moving from `currentStatus` → `newStatus` is valid.
 * @param {string} currentStatus
 * @param {string} newStatus
 * @returns {boolean}
 */
complaintSchema.statics.canTransition = function canTransition(currentStatus, newStatus) {
